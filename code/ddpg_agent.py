...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, n_agents, lr_actor, lr_critic, fc1_unit, fc2_unit):
        ...
        self.noises = [OUNoise(action_size, random_seed) for _ in range(n_agents)]
    ...
    def act(self, state, add_noise=True):
        ...
        if add_noise:
            ...
            action += np.array([noise.sample() for noise in self.noises])
